...
;; プロセスの文字コード設定（Windows）
(when (equal window-system 'w32)
  (modify-coding-system-alist 'process ".*sh\\.exe" 'sjis-dos))
